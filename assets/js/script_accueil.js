...
// FONCTION POUR IMAGE PNG
function updateTextCanvas() {
  const img = new Image();
  img.src = "./assets/images/LOGO_ahp_3D_Blanc_02.png"; // Remplace par le chemin vers ton image

  img.onload = function () {
    textureCtx.clearRect(0, 0, textureEl.width, textureEl.height);
    textureCtx.drawImage(img, 0, 0, textureEl.width, textureEl.height);
